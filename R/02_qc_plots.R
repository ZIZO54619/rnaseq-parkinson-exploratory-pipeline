...
if (!exists("out_figures")) {
  stop("Output directory is not configured. Run source('R/run.R') to initialize configuration.")
}
...
# Boxplot
pdf(file.path(out_figures, "boxplot.pdf"), width = 10, height = 10)
boxplot(Data_sorted,
...
# Density
pdf(file.path(out_figures, "density.pdf"), width = 10, height = 10)
...
# histograms
pdf(file.path(out_figures, "histograms.pdf"), width = 10, height = 10)
